...
XSchemaObject* XSchemaObject::addNewChild(const ESchemaType newType)
{
    ...
    case SchemaTypeSimpleContent: return new XSchemaSimpleContent(this, _root);
    case SchemaTypeSimpleContentRestriction:return new XSchemaSimpleContentRestriction(this, _root);
    case SchemaTypeContentExtension:return new XSchemaSimpleContentExtension(this, _root);
    case SchemaTypeComplexContent:return new XSchemaComplexContent(this, _root);
