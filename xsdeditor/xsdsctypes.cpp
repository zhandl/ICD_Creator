...
void XSchemaSimpleTypeRestriction::loadFromDom(QDomElement &elementToExamine)
{
...
void XSchemaSimpleTypeUnion::loadFromDom(QDomElement &elementToExamine)
{
    XScanContext context ;
    scanDom(elementToExamine, &context);
}
...
void XSchemaSimpleTypeList::loadFromDom(QDomElement &elementToExamine)
{
    XScanContext context ;
    scanDom(elementToExamine, &context);
}

void XSchemaSimpleTypeList::scanForAttributes(QDomAttr &attribute, void * /*context*/)
{
    QString name = attribute.nodeName();
...
void XSchemaSimpleTypeList::scanForElements(QDomElement &element, void *context)
{
    XScanContext *theContext = (XScanContext*) context;
    QString name = element.localName();
    if(element.prefix() == _root->namespacePrefix()) {
