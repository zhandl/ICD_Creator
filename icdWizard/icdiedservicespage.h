#ifndef ICDIEDSERVICESPAGE_H
#define ICDIEDSERVICESPAGE_H
...
class icdIedServicesPage : public QWizardPage
{
    Q_OBJECT
public:
    explicit icdIedServicesPage(QWidget *parent = 0);
    ...
    QLabel *iedNameLabel;
    QLineEdit *iedNameText;
    QCheckBox *iedConfigVersionCheckBox;
    QLabel *iedConfigVersionLabel;
    QLineEdit *iedConfigVersionText;
    QCheckBox *iedTypeCheckBox;
    QLabel *iedTypeLabel;
    QLineEdit *iedTypeText;
    QCheckBox *iedManuCheckBox;
    QLabel *iedManuLabel;
    QLineEdit *iedManuText;
    QCheckBox *iedDescCheckBox;
    QLabel *iedDescLabel;
    QLineEdit *iedDescText;
