...
bool XmlEditWidgetPrivate::finishSetUpUi()
{
    ...
    connect(p->navigation, SIGNAL(navigateTo(const int)), this, SLOT(navigateToPage(const int)));
    ...
    ***************************************************************/
    ...
    p->navigation->setVisible(isNavigation);
    p->navigation->setEnabled(isNavigation);
...
{
    p->navigation->setRange(minFragment, maxFragment);
